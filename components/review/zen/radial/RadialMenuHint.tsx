    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 12px 28px rgba(var(--color-shadow-warm), 0.18), 0 2px 6px rgba(var(--color-shadow-warm), 0.08), inset 0 1px 0 rgba(var(--color-glow-white), 0.45)",
        }}
      >
      ...
      <motion.div
        ...
        style={{
          ...
          filter: "drop-shadow(0 1px 1px rgba(var(--color-shadow-warm), 0.12))",
        }}
        animate={{ y: [0, 3, 0] }}
